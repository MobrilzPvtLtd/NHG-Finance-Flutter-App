     ...
     appBar: AppBar(
          ...
          body:  SafeArea(
            ...
            child: Column(
              ...
              children: [
                const Text("Choose Withdraw Amount",style: TextStyle(
                  fontSize: 30,
                fontWeight: FontWeight.bold),),
                SizedBox(height: 20,),
                const Text("Withdraw Amount",style: TextStyle(
                  fontSize: 25,
                ...
                SizedBox(height: 40,),
                  const Text("WithDraw All Funds From Account (1,234.56 Euro)",style: TextStyle(
                  fontSize: 15,
                fontWeight: FontWeight.bold),),
                SizedBox(height: 40,),
                Center(child: Custom_button(buttonname: "WithDraw", color: Color.fromARGB(255, 5, 167, 204), height: height*0.08, width: width*0.55,Fontsize: 23,))
              ],
            ),
          ),
          );
